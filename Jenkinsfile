node{
  ...
  stage("Deploy") {
    sh "sudo export AWS_ACCESS_KEY_ID=${AWS_ACCESS_KEY_ID}"
    sh "sudo export AWS_SECRET_ACCESS_KEY=${AWS_SECRET_ACCESS_KEY}"
    sh "sudo export AWS_DEFAULT_REGION=${AWS_REGION}"
